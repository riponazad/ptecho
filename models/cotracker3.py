...
from models.cotracker.model_utils import sample_features5d, bilinear_sampler
from models.cotracker.embeddings import get_1d_sincos_pos_embed_from_grid

from models.cotracker.blocks import Mlp, BasicEncoder
from models.cotracker.cotracker import EfficientUpdateFormer
...
class CoTrackerThreeBase(nn.Module):
    def __init__(
        ...
        model_resolution=(256, 256),#(384, 512),
        add_space_attn=True,
